...
initiative_card <- function(img_type, init_name, init_structure, init_date, init_inscription, init_contact, init_besoins, init_lieu, init_horaire) {
  ...
  inscription <- ifelse(
    init_inscription != "",
    paste0(
      "<a style='text-align: left'; href= '", init_inscription,
      "'target='_blank'>inscription ici</a>",
      "<tr>"
      ),
    paste0(
      "<p style='text-align: left; font-size: 15px;'> Inscription: <b>",
  ...
  card_content <- paste0(
    ...
    inscription,
    "<tr>",
    "<p style='text-align: left; font-size: 15px;'> Lieu de rdv et horaire: <b>", paste(init_lieu, init_horaire), "</b></p>",
    "<p style='text-align: left; font-size: 15px;'> Besoins: <b>", init_besoins, "</b></p>"
  )
...
leaflet::leaflet(data = crosstalk_init) |>
  ...
  leaflet::addCircleMarkers(
    ...
    popup = ~initiative_card(image, type_d_action, structure, date_souhaité, inscriptions, contact, besoins_spécifiques, lieu_de_l_action, horaire),
  ) |>
  # leaflet::addCircleMarkers(
  #         radius = 6,
  #         color = ~ pal(statut),
